import 'package:cortex/core/presentation/custom_button.dart';
import 'package:cortex/core/utils/shared_preferences_helper.dart';
...
import '../../../../btm_navigation/bottom_navigation_screen.dart';
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 40,),
                    SvgPicture.string(svg1, width: 200, height: 200,),
                    SizedBox(height: 80,),
                    Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          color: Colors.white,
                          boxShadow: [BoxShadow(
                            color: Color.fromRGBO(91, 45, 152, .4),
                            offset: Offset(0, 10),
                            blurRadius: 20,
                          )],
                        ),
                    ...
                    state is OnLoadingLoginState
                        ? SpinKitThreeBounce(color: COLORs.TopBGColor, size: 25.0)
                        : CustomButton(
                      buttonText: "login",
                      onTap: () {
                        cubit.login(
        ...
        listener: (BuildContext context, LoginState state) async{
          if (state is OnErrorLoginState) {
            ...
            if (state.patientModel.userType.toString() == "Patient") {
              ...
              //print(SharedPreferencesHelper.getString("patient_name"));
            } else {
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(SnackBar(content: Text("Not authorized to login")));
            }
          }
        },
      ),
